...
Page Setup
        ...
        self.Setup_Icons = [self.icon_Page_Setup ,self.icon_IP,self.icon_Serial,self.icon_Audio,self.icon_Selected,self.icon_Chacked_1,self.icon_Chacked_2,self.icon_Checked_3,self.icon_Checked_4]
...
오디오 
        ...
        self.Setup_Audio_Grid_Layout.addWidget(self.lbl_Setup_Audio_Menu_1, 0, 0, 1, 1)
        ...
        self.Setup_Audio_Grid_Layout.addWidget(self.lbl_Setup_Audio_Menu_2, 0, 1, 1, 1)
        ...
        self.Setup_Audio_Grid_Layout.addWidget(self.Setup_Audio_Line_1, 1, 0, 1, 4)

        self.audioPlayButton = ['i']*9
        for i in range(len(self.audioPlayButton)):
            self.audioPlayButton[i] = QtWidgets.QPushButton('{}'.format(i+1),self.Setup_Audio_Page)
            self.audioPlayButton[i].setStyleSheet(self.FN_Style)
            self.audioPlayButton[i].setMinimumSize(QtCore.QSize(100,50))
            self.Setup_Audio_Grid_Layout.addWidget(self.audioPlayButton[i], i/4+2, i%4,1,1)
...
#Slot
        ...
        self.audioButtonGroup.buttonClicked[int].connect(MainWindow.audioPlayButton_Clicked)
...
#라벨
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_Setup_Audio_Menu_1.setText(_translate("MainWindow", "오디오          "))
        self.lbl_Setup_Audio_Menu_2.setText(_translate("MainWindow", ">> 오디오 플레이어"))
