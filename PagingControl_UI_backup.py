...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        self.icon_Page_Setup = QtGui.QIcon(); self.icon_Page_Setup.addPixmap(QtGui.QPixmap(":/Icons/icons/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_Ind_Audio = QtGui.QIcon(); self.icon_Ind_Audio.addPixmap(QtGui.QPixmap(":/Icons/icons/music_dis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off); self.icon_Ind_Audio.addPixmap(QtGui.QPixmap(":/Icons/icons/music.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.icon_ind_Comm = QtGui.QIcon(); self.icon_ind_Comm.addPixmap(QtGui.QPixmap(":/Icons/icons/arrows_dis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off); self.icon_ind_Comm.addPixmap(QtGui.QPixmap(":/Icons/icons/arrows.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.icon_Ind_Server = QtGui.QIcon(); self.icon_Ind_Server.addPixmap(QtGui.QPixmap(":/Icons/icons/database_dis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off); self.icon_Ind_Server.addPixmap(QtGui.QPixmap(":/Icons/icons/database.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.icon_IP = QtGui.QIcon(); self.icon_IP.addPixmap(QtGui.QPixmap(":/Icons/icons/database.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_Serial = QtGui.QIcon(); self.icon_Serial.addPixmap(QtGui.QPixmap(":/Icons/icons/share.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_Audio = QtGui.QIcon(); self.icon_Audio.addPixmap(QtGui.QPixmap(":/Icons/icons/youtube.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_Selected = QtGui.QIcon(); self.icon_Selected.addPixmap(QtGui.QPixmap(":/Icons/icons/selected.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_Chacked_1 = QtGui.QIcon(); self.icon_Chacked_1.addPixmap(QtGui.QPixmap(":/Icons/icons/checked_1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_Chacked_2 = QtGui.QIcon(); self.icon_Chacked_2.addPixmap(QtGui.QPixmap(":/Icons/icons/checked_2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_Checked_3 = QtGui.QIcon(); self.icon_Checked_3.addPixmap(QtGui.QPixmap(":/Icons/icons/checked_4.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_Checked_4 = QtGui.QIcon(); self.icon_Checked_4.addPixmap(QtGui.QPixmap(":/Icons/icons/checked_3.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_home = QtGui.QIcon(); self.icon_home.addPixmap(QtGui.QPixmap(":/Icons/icons/home.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_play = QtGui.QIcon(); self.icon_play.addPixmap(QtGui.QPixmap(":/Icons/icons/play-button_dis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off); self.icon_play.addPixmap(QtGui.QPixmap(":/Icons/icons/play-button.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.icon_pause = QtGui.QIcon(); self.icon_pause.addPixmap(QtGui.QPixmap(":/Icons/icons/pause_dis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off); self.icon_pause.addPixmap(QtGui.QPixmap(":/Icons/icons/pause.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.icon_stop = QtGui.QIcon(); self.icon_stop.addPixmap(QtGui.QPixmap(":/Icons/icons/stop_dis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off); self.icon_stop.addPixmap(QtGui.QPixmap(":/Icons/icons/stop.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.icon_Return = QtGui.QIcon(); self.icon_Return.addPixmap(QtGui.QPixmap(":/Icons/icons/return.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_Plug = QtGui.QIcon(); self.icon_Plug.addPixmap(QtGui.QPixmap(":/Icons/icons/plug.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.saveIcon = QtGui.QIcon(); self.saveIcon.addPixmap(QtGui.QPixmap(":/Icons/icons/save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.indcator_Icons = [self.icon_Ind_Audio, self. icon_ind_Comm, self.icon_Ind_Server]
        ...
        self.RG1_Style = ("QPushButton{background-color:#424242; color:white;border-style:none;} QPushButton:Checked {color : black ; background-color: #E3E9F1; border-style:none;} QPushButton:pressed {color : black ; background-color: #FF0000;border-style:none;}")
        self.RG2_Style = ("QPushButton{background-color:#424242; color:white;border-style:none;} QPushButton:Checked {color : black ; background-color: #EBF1F0; border-style:none;} QPushButton:pressed {color : black ; background-color: #FF0000;border-style:none;}")
        self.RG3_Style = ("QPushButton{background-color:#424242; color:white;border-style:none;} QPushButton:Checked {color : black ; background-color: #E8E5E0; border-style:none;} QPushButton:pressed {color : black ; background-color: #FF0000;border-style:none;}")
        self.RG4_Style = ("QPushButton{background-color:#424242; color:white;border-style:none;} QPushButton:Checked {color : black ; background-color: #E4E6E4; border-style:none;} QPushButton:pressed {color : black ; background-color: #FF0000;border-style:none;}")
        ...
        self.SetupMenu_Style = ("QPushButton{background-color:#2e2e2e; color:white; text-align:left; border-width:0px; border-style:none;} QPushButton:Checked{color: white; border-width:0px; border-style:none}")
        self.QBtn_Border_None = ("QPushButton{color:white; border-style:none;}")

        self.lbl_Style = ("QLabel{color: white; }")
        self.lineEdit_Style = ("QLineEdit {background:white; border: 1px solid gray}")
        self.line_style = ("QFrame {color: white;}")

        self.font_Point_8 = QtGui.QFont(); self.font_Point_8.setFamily("나눔고딕"); self.font_Point_8.setPointSize(8)
        self.font_Point_10 = QtGui.QFont(); self.font_Point_10.setFamily("나눔고딕"); self.font_Point_10.setPointSize(10)
        self.font_Bold_Point_10 = QtGui.QFont(); self.font_Bold_Point_10.setFamily("나눔고딕"); self.font_Bold_Point_10.setPointSize(10); self.font_Bold_Point_10.setBold(True)
        self.font_Point_11 = QtGui.QFont(); self.font_Point_11.setFamily("나눔고딕"); self.font_Point_11.setPointSize(11)
        self.font_Point_12 = QtGui.QFont(); self.font_Point_12.setFamily("나눔고딕"); self.font_Point_12.setPointSize(12)
        self.font_Point_12_Weight_50 = QtGui.QFont(); self.font_Point_12_Weight_50.setFamily("나눔고딕"); self.font_Point_12_Weight_50.setPointSize(12); self.font_Point_12_Weight_50.setWeight(50)
        self.font_Point_13 = QtGui.QFont(); self.font_Point_13.setFamily("나눔고딕"); self.font_Point_13.setPointSize(13)
        self.font_Point_14 = QtGui.QFont(); self.font_Point_14.setFamily("나눔고딕"); self.font_Point_14.setPointSize(14)
        self.font_Bold_Point_14 = QtGui.QFont(); self.font_Bold_Point_14.setFamily("나눔고딕"); self.font_Bold_Point_14.setPointSize(14); self.font_Bold_Point_14.setBold(True)
        self.font_Bold_Point_14_Weight_75 = QtGui.QFont(); self.font_Bold_Point_14_Weight_75.setFamily("나눔고딕"); self.font_Bold_Point_14_Weight_75.setPointSize(14); self.font_Bold_Point_14_Weight_75.setBold(True); self.font_Bold_Point_14_Weight_75.setWeight(75)
        self.font_Bold_Point_16_Weight_75 = QtGui.QFont(); self.font_Bold_Point_16_Weight_75.setFamily("나눔고딕"); self.font_Bold_Point_16_Weight_75.setPointSize(16); self.font_Bold_Point_16_Weight_75.setBold(True); self.font_Bold_Point_16_Weight_75.setWeight(75)
        ...
        icon_Pabicon.addPixmap(QtGui.QPixmap(":/Icons/icons/graphic-design.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.buttonGroup_AudioPlayer = QtWidgets.QButtonGroup(MainWindow)
        self.buttonGroup_AudioPlayer.setObjectName("buttonGroup_AudioPlayer")
        self.buttonGroup_AudioPlayer.setExclusive(True)
...
#Main Menu Buttons
        ...
        self.btn_Main_Page_Setup.setStyleSheet("QPushButton{text-align:left; border-style:none;}")
...
#Relay Group 1
        ...
        self.lbl_Rg1_Name_1.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        self.lbl_Rg1_Name_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        for i in range(26):
            if i <= 7:
                self.btn_RG1_[i] = QtWidgets.QPushButton(self.gridLayoutWidget_RG1)
                self.btn_RG1_[i].setCheckable(True)
                self.gridLayout_RG_1.addWidget(self.btn_RG1_[i], 2, i, 1, 1)                
            elif i > 7 and i <= 15:
                self.btn_RG1_[i] = QtWidgets.QPushButton(self.gridLayoutWidget_RG1)
                self.btn_RG1_[i].setCheckable(True)
                self.gridLayout_RG_1.addWidget(self.btn_RG1_[i], 4, (i - 8), 1, 1)
            elif i > 15 and i <= 23:
                self.btn_RG1_[i] = QtWidgets.QPushButton(self.gridLayoutWidget_RG1)
                self.btn_RG1_[i].setCheckable(True)
                self.gridLayout_RG_1.addWidget(self.btn_RG1_[i], 6, (i - 16), 1, 1)
            elif i == 24:
                self.btn_RG1_[i] = QtWidgets.QPushButton(self.gridLayoutWidget_RG1)
...
#Relay Group 2
        ...
        self.lbl_Rg2_Name_1.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        self.lbl_Rg2_Name_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        for i in range(26):
            if i <= 7:
                self.btn_RG2_[i] = QtWidgets.QPushButton(self.gridLayoutWidget_RG2)
                ...
                self.btn_RG2_[i].setMaximumSize(QtCore.QSize(85, 60))
                self.btn_RG2_[i].setCheckable(True)
                self.gridLayout_RG_2.addWidget(self.btn_RG2_[i], 4, (i - 8), 1, 1)
            elif i > 15 and i <= 23:
                self.btn_RG2_[i] = QtWidgets.QPushButton(self.gridLayoutWidget_RG2)
                self.btn_RG2_[i].setMaximumSize(QtCore.QSize(85, 60))
                self.btn_RG2_[i].setCheckable(True)
                self.gridLayout_RG_2.addWidget(self.btn_RG2_[i], 6, (i - 16), 1, 1)
...
#Relay Group 3
        ...
        self.lbl_Rg3_Name_1.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        self.lbl_Rg3_Name_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        for i in range(26):
            if i <= 7:
                self.btn_RG3_[i] = QtWidgets.QPushButton(self.gridLayoutWidget_RG3)
                ...
                self.btn_RG3_[i].setMaximumSize(QtCore.QSize(85, 60))
                self.btn_RG3_[i].setCheckable(True)
                self.gridLayout_RG_3.addWidget(self.btn_RG3_[i], 4, (i - 8), 1, 1)
            elif i > 15 and i <= 23:
                self.btn_RG3_[i] = QtWidgets.QPushButton(self.gridLayoutWidget_RG3)
                self.btn_RG3_[i].setMaximumSize(QtCore.QSize(85, 60))
                self.btn_RG3_[i].setCheckable(True)
                self.gridLayout_RG_3.addWidget(self.btn_RG3_[i], 6, (i - 16), 1, 1)
...
#Relay Group 4
        ...
        self.lbl_RG4_Name_1.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        self.lbl_RG4_Name_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        for i in range(26):
            if i <= 7:
                self.btn_RG4_[i] = QtWidgets.QPushButton(self.gridLayoutWidget_RG4)
                ...
                self.btn_RG4_[i].setMaximumSize(QtCore.QSize(85, 60))
                self.btn_RG4_[i].setCheckable(True)
                self.gridLayout_RG_4.addWidget(self.btn_RG4_[i], 4, (i - 8), 1, 1)
            elif i > 15 and i <= 23:
                self.btn_RG4_[i] = QtWidgets.QPushButton(self.gridLayoutWidget_RG4)
                self.btn_RG4_[i].setMaximumSize(QtCore.QSize(85, 60))
                self.btn_RG4_[i].setCheckable(True)
                self.gridLayout_RG_4.addWidget(self.btn_RG4_[i], 6, (i - 16), 1, 1)
...
Page Setup
        ...
        self.verticalLayout_SetupMenu = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout_SetupMenu.setObjectName("verticalLayout_SetupMenu")

        self.Setup_Buttons = [str(i) for i in range(8)]
        self.Setup_Icons = [self.icon_Page_Setup ,self.icon_IP,self.icon_Serial,self.icon_Selected,self.icon_Chacked_1,self.icon_Chacked_2,self.icon_Checked_3,self.icon_Checked_4]
        ...
        for i in range(8):
            self.Setup_Buttons[i] = QtWidgets.QPushButton(self.verticalLayoutWidget)
...
#Setup IP Widget
        ...
        self.Setup_IP_Grid_Layout.addWidget(self.Setup_IP_Lines[3], 11, 0, 1, 6)
        self.Setup_IP_Grid_Layout.addWidget(self.Setup_IP_Lines[4], 13, 0, 1, 6)
        ...
        for i in range(6):
            ...
            if i % 2 == 0:
                ...
                self.lbl_Setup_IP_Menu[i].setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing)
            else:
                self.lbl_Setup_IP_Menu[i].setFont(self.font_Point_10)
                self.lbl_Setup_IP_Menu[i].setStyleSheet(self.lbl_Style)
                self.lbl_Setup_IP_Menu[i].setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        for i in range(4):
            ...
            self.Setup_IP_Grid_Layout.addWidget(self.lineEdit_IP[i], 4, (i + 2), 1, 1)
        ...
        for i in range(4):
            ...
            self.Setup_IP_Grid_Layout.addWidget(self.lineEdit_NM[i], 5, (i + 2), 1, 1)
        ...
        for i in range(4):
            ...
            self.Setup_IP_Grid_Layout.addWidget(self.lineEdit_GW[i], 6, (i + 2), 1, 1)
        ...
        self.Setup_IP_Grid_Layout.addWidget(self.lineEdit_Server_Port, 10, 2, 1, 1)
        ...
        for i in range(4):
            ...
            self.Setup_IP_Grid_Layout.addWidget(self.lineEdit_Client[i], 14, (i + 2), 1, 1)
        ...
        self.Setup_IP_Grid_Layout.addWidget(self.lineEdit_Client_Port, 15, 2, 1, 1)
        ...
        self.Setup_IP_Grid_Layout.addWidget(self.lineEdit_Client_ID, 16, 2, 1, 1)
...
시리얼 통신
        ...
        self.Setup_Serial_Grid_Layout = QtWidgets.QGridLayout(self.Setup_Serial_Page)
        ...
        self.lbl_Setup_Serial_Menu_1.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing)
        self.Setup_Serial_Grid_Layout.addWidget(self.lbl_Setup_Serial_Menu_1, 0, 0, 1, 1)
        ...
        self.lbl_Setup_Serial_Menu_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.Setup_Serial_Grid_Layout.addWidget(self.lbl_Setup_Serial_Menu_2, 0, 1, 1, 2)
        ...
        self.lbl_Setup_Serial_Menu_3.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing)
        self.Setup_Serial_Grid_Layout.addWidget(self.lbl_Setup_Serial_Menu_3, 4, 0, 1, 1)
        ...
        self.lbl_Setup_Serial_Menu_4.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.Setup_Serial_Grid_Layout.addWidget(self.lbl_Setup_Serial_Menu_4, 4, 1, 1, 2)
        ...
        self.Setup_Serial_Grid_Layout.addWidget(self.lbl_Setup_Serial_1, 2, 1, 1, 1)
        ...
        self.Setup_Serial_Grid_Layout.addWidget(self.lbl_Setup_Serial_2, 6, 1, 1, 1)
        ...
        self.Setup_Serial_Grid_Layout.addWidget(self.lbl_Setup_Serial_3, 7, 1, 1, 1)
        ...
        self.Setup_Serial_Grid_Layout.addWidget(self.Setup_Serial_Line_1, 1, 0, 1, 4)
        ...
        self.Setup_Serial_Grid_Layout.addWidget(self.Setup_Serial_Line_2, 3, 0, 1, 4)
        ...
        self.Setup_Serial_Grid_Layout.addWidget(self.Setup_Serial_Line_3, 5, 0, 1, 4)
        ...
        self.Setup_Serial_Grid_Layout.addWidget(self.comboBox_Serial_Mode, 2, 2, 1, 2)

        self.lineEdit_Bss_Reboot_Code = QtWidgets.QLineEdit(self.Setup_Serial_Page)
        ...
        self.Setup_Serial_Grid_Layout.addWidget(self.lineEdit_Bss_Reboot_Code, 6, 2, 1, 2)
...
오디오 
        ...
        self.Setup_Audio_Page.setGeometry(QtCore.QRect(50, 100, 474, 82))
        self.Setup_Audio_Page.setObjectName("Setup_Audio_Page")

        self.Setup_Audio_Grid_Layout = QtWidgets.QGridLayout(self.Setup_Audio_Page)
        self.Setup_Audio_Grid_Layout.setHorizontalSpacing(20)
        ...
        self.lbl_Setup_Audio_Menu_1.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing)
        self.Setup_Audio_Grid_Layout.addWidget(self.lbl_Setup_Audio_Menu_1, 0, 0, 1, 2)
        ...
        self.lbl_Setup_Audio_Menu_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.Setup_Audio_Grid_Layout.addWidget(self.lbl_Setup_Audio_Menu_2, 0, 2, 1, 1)
        ...
        self.Setup_Audio_Grid_Layout.addWidget(self.Setup_Audio_Line_1, 1, 0, 1, 3)
...
상태 값 저장
        ...
        self.Setup_Save_Grid_Layout = QtWidgets.QGridLayout(self.Setup_Save_Page)
        ...
        self.Setup_Save_Grid_Layout.addWidget(self.Setup_Save_Lines[0], 1, 0, 1, 3)
        self.Setup_Save_Grid_Layout.addWidget(self.Setup_Save_Lines[1], 3, 0, 1, 3)
        self.Setup_Save_Grid_Layout.addWidget(self.Setup_Save_Lines[2], 6, 0, 1, 3)
        self.Setup_Save_Grid_Layout.addWidget(self.Setup_Save_Lines[3], 8, 0, 1, 3)
        self.Setup_Save_Grid_Layout.addWidget(self.Setup_Save_Lines[4], 10, 0, 1, 3)
        self.Setup_Save_Grid_Layout.addWidget(self.Setup_Save_Lines[5], 12, 0, 1, 3)

        self.lbl_Setup_Save = [str(i) for i in range(6)]
        for i in range(6):
            self.lbl_Setup_Save[i] = QtWidgets.QLabel(self.Setup_Save_Page)
            if i % 2 == 0:
                self.lbl_Setup_Save[i].setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing)
                self.lbl_Setup_Save[i].setFont(self.font_Bold_Point_14)
                self.lbl_Setup_Save[i].setStyleSheet(self.lbl_Style)
            else:
                self.lbl_Setup_Save[i].setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
                self.lbl_Setup_Save[i].setFont(self.font_Point_10)
                self.lbl_Setup_Save[i].setStyleSheet(self.lbl_Style)

        self.Setup_Save_Grid_Layout.addWidget(self.lbl_Setup_Save[0], 0, 0, 1, 1)
        self.Setup_Save_Grid_Layout.addWidget(self.lbl_Setup_Save[1], 0, 1, 1, 1)
        self.Setup_Save_Grid_Layout.addWidget(self.lbl_Setup_Save[2], 5, 0, 1, 1)
        self.Setup_Save_Grid_Layout.addWidget(self.lbl_Setup_Save[3], 5, 1, 1, 1)
        self.Setup_Save_Grid_Layout.addWidget(self.lbl_Setup_Save[4], 9, 0, 1, 1)
        self.Setup_Save_Grid_Layout.addWidget(self.lbl_Setup_Save[5], 9, 1, 1, 1)

        self.btn_Setup_Save = [str(i) for i in range(5)]
        for i in range(5):
            self.btn_Setup_Save[i] = QtWidgets.QPushButton(self.Setup_Save_Page)
        ...
        self.Setup_Save_Grid_Layout.addWidget(self.btn_Setup_Save[0], 2, 1, 1, 1)
        self.Setup_Save_Grid_Layout.addWidget(self.btn_Setup_Save[1], 2, 2, 1, 1)
        self.Setup_Save_Grid_Layout.addWidget(self.btn_Setup_Save[2], 7, 1, 1, 1)
        self.Setup_Save_Grid_Layout.addWidget(self.btn_Setup_Save[3], 7, 2, 1, 1)
        self.Setup_Save_Grid_Layout.addWidget(self.btn_Setup_Save[4], 11, 1, 1, 1)
...
릴레이 그룹 셋업 1
        ...
        self.Setup_Button_Name_1_Page.setGeometry(QtCore.QRect(10, 20, 150, 50))

        self.Setup_Button_Name_1_Name_Labels = QtWidgets.QHBoxLayout(self.Setup_Button_Name_1_Page)

        self.lbl_Setup_Buttons_1_Name_1 = QtWidgets.QLabel(self.Setup_Button_Name_1_Page)
        ...
        self.lbl_Setup_Buttons_1_Name_1.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing)
        self.Setup_Button_Name_1_Name_Labels.addWidget(self.lbl_Setup_Buttons_1_Name_1)

        self.lbl_Setup_Buttons_1_Name_2 = QtWidgets.QLabel(self.Setup_Button_Name_1_Page)
        self.lbl_Setup_Buttons_1_Name_2.setFont(self.font_Point_10)
        self.lbl_Setup_Buttons_1_Name_2.setStyleSheet(self.lbl_Style)
        self.lbl_Setup_Buttons_1_Name_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.Setup_Button_Name_1_Name_Labels.addWidget(self.lbl_Setup_Buttons_1_Name_2)

        self.Setup_Button_Name_1 = QtWidgets.QWidget(self.page_RG1)
        self.Setup_Button_Name_1.setGeometry(QtCore.QRect(10, 60, 631, 261))

        self.Setup_Buttons_1_Grid_Layout = QtWidgets.QGridLayout(self.Setup_Button_Name_1)

        for i in range(24):
            if i <= 7:
                self.lbl_Setup_Buttons_NameTag_1[i] = QtWidgets.QLabel(self.Setup_Button_Name_1)
                
                self.lineEdit_Setup_Buttons_Name_1_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_1)
                
                self.Setup_Buttons_1_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_1[i], 1, i, 1, 1)
                self.Setup_Buttons_1_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_1_[i], 2, i, 1, 1)
            elif i > 7 and i <= 15:
                self.lbl_Setup_Buttons_NameTag_1[i] = QtWidgets.QLabel(self.Setup_Button_Name_1)
                self.lineEdit_Setup_Buttons_Name_1_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_1)
                self.Setup_Buttons_1_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_1[i], 4, (i - 8), 1, 1)
                self.Setup_Buttons_1_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_1_[i], 5, (i - 8), 1, 1)
            else:
                self.lbl_Setup_Buttons_NameTag_1[i] = QtWidgets.QLabel(self.Setup_Button_Name_1)
                self.lineEdit_Setup_Buttons_Name_1_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_1)
                self.Setup_Buttons_1_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_1[i], 8, (i - 16), 1, 1)
                self.Setup_Buttons_1_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_1_[i], 9, (i - 16), 1, 1)

            self.lbl_Setup_Buttons_NameTag_1[i].setStyleSheet(self.lbl_Style)
            self.lbl_Setup_Buttons_NameTag_1[i].setMinimumSize(QtCore.QSize(0, 25))
            self.lbl_Setup_Buttons_NameTag_1[i].setFont(self.font_Point_10)
            self.lbl_Setup_Buttons_NameTag_1[i].setAlignment(QtCore.Qt.AlignCenter)
            self.lineEdit_Setup_Buttons_Name_1_[i].setStyleSheet(self.lineEdit_Style)   
            self.lineEdit_Setup_Buttons_Name_1_[i].setMinimumSize(QtCore.QSize(0, 25))
            self.lineEdit_Setup_Buttons_Name_1_[i].setFont(self.font_Point_10)

        self.Setup_Buttons_name_Lines_1 = [str(i) for i in range(4)]
        for i in range(4):
            self.Setup_Buttons_name_Lines_1[i] = QtWidgets.QFrame(self.Setup_Button_Name_1)
            self.Setup_Buttons_name_Lines_1[i].setFrameShape(QtWidgets.QFrame.HLine)
            self.Setup_Buttons_name_Lines_1[i].setStyleSheet(self.line_style)
        self.Setup_Buttons_1_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_1[0], 0, 0, 1, 8)
        self.Setup_Buttons_1_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_1[1], 3, 0, 1, 8)
        self.Setup_Buttons_1_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_1[2], 7, 0, 1, 8)
        self.Setup_Buttons_1_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_1[3], 10, 0, 1, 8)
...
릴레이 그룹 셋팅 2
        ...
        self.Setup_Button_Name_2_Page.setGeometry(QtCore.QRect(10, 20, 150, 50))
        
        self.Setup_Button_Name_2_Name_Labels = QtWidgets.QHBoxLayout(self.Setup_Button_Name_2_Page)
        
        self.lbl_Setup_Buttons_2_Name_1 = QtWidgets.QLabel(self.Setup_Button_Name_2_Page)
        ...
        self.lbl_Setup_Buttons_2_Name_1.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing)
        self.Setup_Button_Name_2_Name_Labels.addWidget(self.lbl_Setup_Buttons_2_Name_1)

        self.lbl_Setup_Buttons_2_Name_2 = QtWidgets.QLabel(self.Setup_Button_Name_2_Page)
        self.lbl_Setup_Buttons_2_Name_2.setFont(self.font_Point_10)
        self.lbl_Setup_Buttons_2_Name_2.setStyleSheet(self.lbl_Style)
        self.lbl_Setup_Buttons_2_Name_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.Setup_Button_Name_2_Name_Labels.addWidget(self.lbl_Setup_Buttons_2_Name_2)

        self.Setup_Button_Name_2 = QtWidgets.QWidget(self.page_RG2)
        self.Setup_Button_Name_2.setGeometry(QtCore.QRect(10, 60, 631, 261))

        self.Setup_Buttons_2_Grid_Layout = QtWidgets.QGridLayout(self.Setup_Button_Name_2)

        for i in range(24):
            if i <= 7:
                self.lbl_Setup_Buttons_NameTag_2[i] = QtWidgets.QLabel(self.Setup_Button_Name_2)
                self.lineEdit_Setup_Buttons_Name_2_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_2)
                self.Setup_Buttons_2_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_2[i], 1, i, 1, 1)
                self.Setup_Buttons_2_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_2_[i], 2, i, 1, 1)
            elif i > 7 and i <= 15:
                self.lbl_Setup_Buttons_NameTag_2[i] = QtWidgets.QLabel(self.Setup_Button_Name_2)
                self.lineEdit_Setup_Buttons_Name_2_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_2)
                self.Setup_Buttons_2_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_2[i], 4, (i - 8), 1, 1)
                self.Setup_Buttons_2_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_2_[i], 5, (i - 8), 1, 1)
            else:
                self.lbl_Setup_Buttons_NameTag_2[i] = QtWidgets.QLabel(self.Setup_Button_Name_2)
                self.lineEdit_Setup_Buttons_Name_2_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_2)
                self.Setup_Buttons_2_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_2[i], 8, (i - 16), 1, 1)
                self.Setup_Buttons_2_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_2_[i], 9, (i - 16), 1, 1)


            self.lbl_Setup_Buttons_NameTag_2[i].setStyleSheet(self.lbl_Style)
            self.lbl_Setup_Buttons_NameTag_2[i].setMinimumSize(QtCore.QSize(0, 25))
            self.lbl_Setup_Buttons_NameTag_2[i].setFont(self.font_Point_10)
            self.lbl_Setup_Buttons_NameTag_2[i].setAlignment(QtCore.Qt.AlignCenter)
            self.lineEdit_Setup_Buttons_Name_2_[i].setStyleSheet(self.lineEdit_Style)
            self.lineEdit_Setup_Buttons_Name_2_[i].setMinimumSize(QtCore.QSize(0, 25))
            self.lineEdit_Setup_Buttons_Name_2_[i].setFont(self.font_Point_10)
        
        self.Setup_Buttons_name_Lines_2 = [str(i) for i in range(4)]
        for i in range(4):
            self.Setup_Buttons_name_Lines_2[i] = QtWidgets.QFrame(self.Setup_Button_Name_2)
            self.Setup_Buttons_name_Lines_2[i].setFrameShape(QtWidgets.QFrame.HLine)
            self.Setup_Buttons_name_Lines_2[i].setStyleSheet(self.line_style)
        self.Setup_Buttons_2_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_2[0], 0, 0, 1, 8)
        self.Setup_Buttons_2_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_2[1], 3, 0, 1, 8)
        self.Setup_Buttons_2_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_2[2], 7, 0, 1, 8)
        self.Setup_Buttons_2_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_2[3], 10, 0, 1, 8)
...
릴레이 버튼 세팅 3
        ...
        self.Setup_Button_Name_3_Page.setGeometry(QtCore.QRect(10, 20, 150, 50))

        self.Setup_Button_Name_3_Name_Labels = QtWidgets.QHBoxLayout(self.Setup_Button_Name_3_Page)

        self.lbl_Setup_Buttons_3_Name_1 = QtWidgets.QLabel(self.Setup_Button_Name_3_Page)
        ...
        self.lbl_Setup_Buttons_3_Name_1.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing)
        self.Setup_Button_Name_3_Name_Labels.addWidget(self.lbl_Setup_Buttons_3_Name_1)

        self.lbl_Setup_Buttons_3_Name_2 = QtWidgets.QLabel(self.Setup_Button_Name_3_Page)
        self.lbl_Setup_Buttons_3_Name_2.setFont(self.font_Point_10)
        self.lbl_Setup_Buttons_3_Name_2.setStyleSheet(self.lbl_Style)
        self.lbl_Setup_Buttons_3_Name_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.Setup_Button_Name_3_Name_Labels.addWidget(self.lbl_Setup_Buttons_3_Name_2)

        self.Setup_Button_Name_3 = QtWidgets.QWidget(self.page_RG3)
        self.Setup_Button_Name_3.setGeometry(QtCore.QRect(10, 60, 631, 261))

        self.Setup_Buttons_3_Grid_Layout = QtWidgets.QGridLayout(self.Setup_Button_Name_3)

        for i in range(24):
            if i <= 7:
                self.lbl_Setup_Buttons_NameTag_3[i] = QtWidgets.QLabel(self.Setup_Button_Name_3)
                self.lineEdit_Setup_Buttons_Name_3_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_3)
                self.Setup_Buttons_3_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_3[i], 1, i, 1, 1)
                self.Setup_Buttons_3_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_3_[i], 2, i, 1, 1)
            elif i > 7 and i <= 15:
                self.lbl_Setup_Buttons_NameTag_3[i] = QtWidgets.QLabel(self.Setup_Button_Name_3)
                self.lineEdit_Setup_Buttons_Name_3_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_3)
                self.Setup_Buttons_3_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_3[i], 4, (i - 8), 1, 1)
                self.Setup_Buttons_3_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_3_[i], 5, (i - 8), 1, 1)
            else:
                self.lbl_Setup_Buttons_NameTag_3[i] = QtWidgets.QLabel(self.Setup_Button_Name_3)
                self.lineEdit_Setup_Buttons_Name_3_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_3)
                self.Setup_Buttons_3_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_3[i], 8, (i - 16), 1, 1)
                self.Setup_Buttons_3_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_3_[i], 9, (i - 16), 1, 1)

            self.lbl_Setup_Buttons_NameTag_3[i].setStyleSheet(self.lbl_Style) 
            self.lbl_Setup_Buttons_NameTag_3[i].setMinimumSize(QtCore.QSize(0, 25))
            self.lbl_Setup_Buttons_NameTag_3[i].setFont(self.font_Point_10)
            self.lbl_Setup_Buttons_NameTag_3[i].setAlignment(QtCore.Qt.AlignCenter)
            self.lineEdit_Setup_Buttons_Name_3_[i].setStyleSheet(self.lineEdit_Style)
            self.lineEdit_Setup_Buttons_Name_3_[i].setMinimumSize(QtCore.QSize(0, 25))
            self.lineEdit_Setup_Buttons_Name_3_[i].setFont(self.font_Point_10)
        
        self.Setup_Buttons_name_Lines_3 = [str(i) for i in range(4)]
        for i in range(4):
            self.Setup_Buttons_name_Lines_3[i] = QtWidgets.QFrame(self.Setup_Button_Name_3)
            self.Setup_Buttons_name_Lines_3[i].setFrameShape(QtWidgets.QFrame.HLine)
            self.Setup_Buttons_name_Lines_3[i].setStyleSheet(self.line_style)
        self.Setup_Buttons_3_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_3[0], 0, 0, 1, 8)
        self.Setup_Buttons_3_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_3[1], 3, 0, 1, 8)
        self.Setup_Buttons_3_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_3[2], 7, 0, 1, 8)
        self.Setup_Buttons_3_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_3[3], 10, 0, 1, 8)
...
릴레이 버튼 세팅 4
        ...
        self.Setup_Button_Name_4_Page.setGeometry(QtCore.QRect(10, 20, 150, 50))

        self.Setup_Button_Name_4_Name_Labels = QtWidgets.QHBoxLayout(self.Setup_Button_Name_4_Page)

        self.lbl_Setup_Buttons_4_Name_1 = QtWidgets.QLabel(self.Setup_Button_Name_4_Page)
        ...
        self.lbl_Setup_Buttons_4_Name_1.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing)
        self.Setup_Button_Name_4_Name_Labels.addWidget(self.lbl_Setup_Buttons_4_Name_1)

        self.lbl_Setup_Buttons_4_Name_2 = QtWidgets.QLabel(self.Setup_Button_Name_4_Page)
        self.lbl_Setup_Buttons_4_Name_2.setFont(self.font_Point_10)
        self.lbl_Setup_Buttons_4_Name_2.setStyleSheet(self.lbl_Style)
        self.lbl_Setup_Buttons_4_Name_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.Setup_Button_Name_4_Name_Labels.addWidget(self.lbl_Setup_Buttons_4_Name_2)        

        self.Setup_Button_Name_4 = QtWidgets.QWidget(self.page_RG4)
        self.Setup_Button_Name_4.setGeometry(QtCore.QRect(10, 60, 631, 261))

        self.Setup_Buttons_4_Grid_Layout = QtWidgets.QGridLayout(self.Setup_Button_Name_4)
        self.Setup_Buttons_4_Grid_Layout.setObjectName("Setup_Buttons_4_Grid_Layout")

        for i in range(24):
            if i <= 7:
                self.lbl_Setup_Buttons_NameTag_4[i] = QtWidgets.QLabel(self.Setup_Button_Name_4)
                self.lineEdit_Setup_Buttons_Name_4_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_4)
                self.Setup_Buttons_4_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_4[i], 1, i, 1, 1)
                self.Setup_Buttons_4_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_4_[i], 2, i, 1, 1)
            elif i > 7 and i <= 15:
                self.lbl_Setup_Buttons_NameTag_4[i] = QtWidgets.QLabel(self.Setup_Button_Name_4)
                self.lineEdit_Setup_Buttons_Name_4_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_4)
                self.Setup_Buttons_4_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_4[i], 4, (i - 8), 1, 1)
                self.Setup_Buttons_4_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_4_[i], 5, (i - 8), 1, 1)
            else:
                self.lbl_Setup_Buttons_NameTag_4[i] = QtWidgets.QLabel(self.Setup_Button_Name_4)
                self.lineEdit_Setup_Buttons_Name_4_[i] = QtWidgets.QLineEdit(self.Setup_Button_Name_4)
                self.Setup_Buttons_4_Grid_Layout.addWidget(self.lbl_Setup_Buttons_NameTag_4[i], 8, (i - 16), 1, 1)
                self.Setup_Buttons_4_Grid_Layout.addWidget(self.lineEdit_Setup_Buttons_Name_4_[i], 9, (i - 16), 1, 1)

            self.lbl_Setup_Buttons_NameTag_4[i].setStyleSheet(self.lbl_Style)  
            self.lbl_Setup_Buttons_NameTag_4[i].setMinimumSize(QtCore.QSize(0, 25))
            self.lbl_Setup_Buttons_NameTag_4[i].setFont(self.font_Point_10)
            self.lbl_Setup_Buttons_NameTag_4[i].setAlignment(QtCore.Qt.AlignCenter)
            self.lineEdit_Setup_Buttons_Name_4_[i].setStyleSheet(self.lineEdit_Style)
            self.lineEdit_Setup_Buttons_Name_4_[i].setMinimumSize(QtCore.QSize(0, 25))
            self.lineEdit_Setup_Buttons_Name_4_[i].setFont(self.font_Point_10)

        self.Setup_Buttons_name_Lines_4 = [str(i) for i in range(4)]
        for i in range(4):
            self.Setup_Buttons_name_Lines_4[i] = QtWidgets.QFrame(self.Setup_Button_Name_3)
            self.Setup_Buttons_name_Lines_4[i].setFrameShape(QtWidgets.QFrame.HLine)
            self.Setup_Buttons_name_Lines_4[i].setStyleSheet(self.line_style)
        self.Setup_Buttons_4_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_4[0], 0, 0, 1, 8)
        self.Setup_Buttons_4_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_4[1], 3, 0, 1, 8)
        self.Setup_Buttons_4_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_4[2], 7, 0, 1, 8)
        self.Setup_Buttons_4_Grid_Layout.addWidget(self.Setup_Buttons_name_Lines_4[3], 10, 0, 1, 8)
...
#Status Bar
        ...
        self.statusbar.setStyleSheet("QStatusBar { min-height: 25;  color:white; background-color:#6E6E6E}")
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        """
#Slot
        self.buttonGroup_MainMenu.buttonClicked.connect(MainWindow.main_Page_Change)
        self.buttonGroup_Setup.buttonClicked[int].connect(MainWindow.setup_Page_Change)
        self.buttonGroup_RG1.buttonClicked[int].connect(MainWindow.btn_Clicked_RG_1)
        self.buttonGroup_RG2.buttonClicked[int].connect(MainWindow.btn_Clicked_RG_2)
        self.buttonGroup_RG3.buttonClicked[int].connect(MainWindow.btn_Clicked_RG_3)
        self.buttonGroup_RG4.buttonClicked[int].connect(MainWindow.btn_Clicked_RG_4)
        ...
        self.Main_Menu_Indcators[2].clicked.connect(MainWindow.ind_Network_Check)
        ...
        self.comboBox_Serial_Mode.currentIndexChanged.connect(MainWindow.serialModeChange)
        ...
        self.lineEdit_Client[0].selectionChanged.connect(MainWindow.touchInput_CLIENT)
        self.lineEdit_Client[1].selectionChanged.connect(MainWindow.touchInput_CLIENT)
        self.lineEdit_Client[2].selectionChanged.connect(MainWindow.touchInput_CLIENT)
        self.lineEdit_Client[3].selectionChanged.connect(MainWindow.touchInput_CLIENT)

        self.lineEdit_Server_Port.selectionChanged.connect(MainWindow.touchInput_ServerPort)
        self.lineEdit_Client_Port.selectionChanged.connect(MainWindow.touchInput_ClientPort)
        self.lineEdit_Client_ID.selectionChanged.connect(MainWindow.touchInput_LocalID)
...
#라벨
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Paging Controller"))
        self.Main_Menu_Buttons[0].setText(_translate("MainWindow", "Relay\nGroup 1"))
        self.Main_Menu_Buttons[1].setText(_translate("MainWindow", "Relay\nGroup 2"))
        self.Main_Menu_Buttons[2].setText(_translate("MainWindow", "Relay\nGroup 3"))
        self.Main_Menu_Buttons[3].setText(_translate("MainWindow", "Relay\nGroup 4"))
        ...
        self.Setup_Buttons[3].setText(_translate("MainWindow", " 설정 저장"))
        self.Setup_Buttons[4].setText(_translate("MainWindow", " 그룹 1"))
        self.Setup_Buttons[5].setText(_translate("MainWindow", " 그룹 2"))
        self.Setup_Buttons[6].setText(_translate("MainWindow", " 그룹 3"))
        self.Setup_Buttons[7].setText(_translate("MainWindow", " 그룹 4"))

        self.setFunctionButton1.setText(_translate("MainWindow","지점 마이크"))
        self.setFunctionButton2.setText(_translate("MainWindow","지점 조회"))
        ...
        self.lbl_Setup_IP_Menu[1].setText(_translate("MainWindow", ">> 시스템 IP 설정"))
        ...
        self.lbl_Setup_IP_Menu[5].setText(_translate("MainWindow", ">> 클라이언트 설정"))

        self.lbl_Setup_Serial_Menu_1.setText(_translate("MainWindow", "시리얼 통신"))
        self.lbl_Setup_Serial_Menu_2.setText(_translate("MainWindow", ">> 시리얼 통신 설정"))
        self.lbl_Setup_Serial_Menu_3.setText(_translate("MainWindow", "시리얼 통신"))
        self.lbl_Setup_Serial_Menu_4.setText(_translate("MainWindow", ">> BSS 재부팅 설정"))
        ...
        '''
        self.lbl_Setup_Audio_Menu_1.setText(_translate("MainWindow", "오디오 스트리밍"))
        self.lbl_Setup_Audio_Menu_2.setText(_translate("MainWindow", ">> 오디오 스트리밍 주소 설정"))
        ...
        self.lbl_Setup_Buttons_1_Name_1.setText(_translate("MainWindow", "그룹1"))
        self.lbl_Setup_Buttons_1_Name_2.setText(_translate("MainWindow", ">> 버튼 이름"))
        for i in range(24):
            self.lbl_Setup_Buttons_NameTag_1[i].setText(_translate("MainWindow","CH {}".format(i + 1)))
        self.lbl_Setup_Buttons_2_Name_1.setText(_translate("MainWindow", "그룹2"))
        self.lbl_Setup_Buttons_2_Name_2.setText(_translate("MainWindow", ">> 버튼 이름"))
        for i in range(24):
            self.lbl_Setup_Buttons_NameTag_2[i].setText(_translate("MainWindow","CH {}".format(i + 1)))
        self.lbl_Setup_Buttons_3_Name_1.setText(_translate("MainWindow", "그룹3"))
        self.lbl_Setup_Buttons_3_Name_2.setText(_translate("MainWindow", ">> 버튼 이름"))
        for i in range(24):
            self.lbl_Setup_Buttons_NameTag_3[i].setText(_translate("MainWindow","CH {}".format(i + 1)))
        self.lbl_Setup_Buttons_4_Name_1.setText(_translate("MainWindow", "그룹4"))
        self.lbl_Setup_Buttons_4_Name_2.setText(_translate("MainWindow", ">> 버튼 이름"))
        for i in range(24):
            self.lbl_Setup_Buttons_NameTag_4[i].setText(_translate("MainWindow","CH {}".format(i + 1)))
